...
async def changelog(ctx):
    ...
    changelog.add_field(name="Credits", value="▸ Bjax & Ruler <3", inline=False)
...
async def stats(ctx):
	...
	embed.set_footer(text="Discord Bot Developed By Bjax and Ruler <3")
